...
public final class Recipe {
	...
	public Recipe(String recipeName, String description, Integer preparationTime, Integer cookingTime, String imagePath,
			User user, List<Step> steps, List<Ingredient> ingredients) {
		this(null, recipeName, description, preparationTime, cookingTime, imagePath, user, steps, ingredients, 1);
	}
	...
	public Recipe(Integer recipeID, String recipeName, String description, Integer preparationTime, Integer cookingTime,
			String imagePath, User owner, List<Step> steps, List<Ingredient> ingredients, Integer status) {
		super();
