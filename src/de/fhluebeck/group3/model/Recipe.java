...
public final class Recipe {
	...
	public Recipe(String recipeName, String description, Integer preparationTime, Integer cookingTime, String imagePath,
			User user, List<Step> steps, List<Ingredient> ingredients, Integer availeblPeople) {
		this(null, recipeName, description, preparationTime, cookingTime, imagePath, user, availeblPeople, steps,
				ingredients, 1);
	}
	...
	public Recipe(Integer recipeID, String recipeName, String description, Integer preparationTime, Integer cookingTime,
			String imagePath, User owner, Integer availablePeople, List<Step> steps, List<Ingredient> ingredients,
			Integer status) {
		super();
	...
	public String toString() {
		return "Recipe [recipeID=" + recipeID + ", recipeName=" + recipeName + ", description=" + description
				...
				+ ", owner=" + owner + ", availablePeople=" + availablePeople + ", steps=" + steps + ", ingredients="
