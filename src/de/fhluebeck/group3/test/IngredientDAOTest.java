...
public class IngredientDAOTest {
	...
	public void testupdateBatchIngredients() {
		...
		Ingredient updatetestIngredient1 = new Ingredient(809, "testIngredient1updated", (double) 2, 314, "teaspooon",
				"testStyleupdated");
		Ingredient updatetestIngredient2 = new Ingredient(996, "testIngredient2updated", (double) 3, 314, "teaspooon",
				"testStyleupdated!");
		...
		assertEquals(IngredientDAO.searchIngredientByRecipeId(314).get(1).getIngredientName(),
				"testIngredient2updated");
	}
	...
	public void testDeleteBatchIngredients() {
		...
		Ingredient testIngredient1 = new Ingredient(809, "testIngredient1updated", (double) 2, 314, "teaspooon",
				"testStyleupdated");
		Ingredient testIngredient2 = new Ingredient(996, "testIngredient2updated", (double) 3, 314, "teaspooon",
				"testStyleupdated!");
